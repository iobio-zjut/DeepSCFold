...
if __name__ == '__main__':
    ...
    #input
    parser.add_argument('-emp', '--esm_model_path', type=str, default='/home/data/user/zhaohongh/wpc/MSA/PLMSearch/PLMSearch-main/plmsearch/esm/saved_models/esm1b_t33_650M_UR50S.pt', help="ESM model location")
