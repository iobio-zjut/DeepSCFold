...
def plm_interact(outdir, alignment, a3m_alignment, file_name):
    ...
    if len(a3m_alignment) > 0:
        ...
        if len(a3m_alignment) == 2:
            ...
            os.system(
                f"python {code_dimer} --input_msa_1 {temp_chainA_a3m} --input_msa_2 {temp_chainB_a3m} --output_dir {dir} --output_pairs_csv {out_csv} --output_msa_for_chain1 {con_A} --output_msa_for_chain2 {con_B} --output_complex_msa {complex_a3m}"
            )
            ...
            os.system(
                f"python {code_trimer} --input_msa_1 {temp_chainA_a3m} --input_msa_2 {temp_chainB_a3m} --input_msa_3 {temp_chainC_a3m} --output_dir {dir} --output_pairs_csv_fileName {out_csv} --output_msa_for_chain1 {con_A} --output_msa_for_chain2 {con_B} --output_msa_for_chain3 {con_C} --output_complex_msa {complex_a3m}"
            )
