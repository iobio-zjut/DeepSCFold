    ...
    def __init__(self, params, run_methods=None):
        ...
        if run_methods is None:
            self.run_methods = ['default',
                                ...
                                'PLM_interact_uniref_a3m',
                                'PLM_interact_uniref_sto',
                                'PLM_interact_uniprot_sto',
                                'PLM_seq_sim_uniref_a3m',
                                'PLM_seq_sim_uniref_sto',
                                'PLM_seq_sim_uniprot_sto',
                                'PLM_str_sim_uniref_a3m',
                                'PLM_str_sim_uniref_sto',
                                'PLM_str_sim_uniprot_sto'
                                'plm_interact_uniref_a3m',
                                'plm_interact_uniref_sto',
                                'plm_interact_uniprot_sto',
                                'plm_interact_structureSim_uniref_a3m',
                                'plm_interact_structureSim_uniref_sto',
                                'plm_interact_structureSim_uniprot_sto',
                                ]
        else:
        ...
        self.method2dir = {'default': 'default_multimer',
                           ...
                           'plm_interact_uniref_a3m': 'plm_seq_sim_uniref_a3m',
                           'plm_interact_uniref_sto': 'plm_seq_sim_uniref_sto',
                           'plm_interact_uniprot_sto': 'plm_seq_sim_uniprot_sto',
                           'plm_interact_structureSim_uniref_a3m': 'plm_str_sim_uniref_a3m',
                           'plm_interact_structureSim_uniref_sto': 'plm_str_sim_uniref_sto',
                           'plm_interact_structureSim_uniprot_sto': 'plm_str_sim_uniprot_sto',
