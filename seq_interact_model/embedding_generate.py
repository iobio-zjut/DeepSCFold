...
if __name__ == '__main__':
    ...
    #input
    parser.add_argument('-emp', '--esm_model_path', type=str, default='/home/data/user/minghuah/AAA_newWork/MultiCOM/MULTICOM3-compareAFM_Convnext/MSArank_model/esm/saved_models/ESM-2/esm2_t33_650M_UR50D.pt', help="ESM model location")
